    ...
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-3xl bg-white shadow-xl z-50 overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-8 bg-gray-50">
          <div className="bg-white shadow-sm rounded-lg p-8 space-y-6 border border-gray-200 max-w-4xl mx-auto">
            {/* Company Header */}
            ...
            <div className="grid grid-cols-2 gap-8">
              <div>
                ...
                <input
                  ...
                  } focus:border-blue-600 focus:ring-0 outline-none text-sm text-gray-900 placeholder-gray-400`}
                />
                {errors.customer && (
              ...
              <div>
                ...
                <input
                  ...
                  } focus:border-blue-600 focus:ring-0 outline-none text-sm`}
                />
                {errors.dueDate && (
                  <p className="text-[10px] text-red-600 mt-1">{errors.dueDate}</p>
                )}
              </div>
            </div>
                ...
                <table className="w-full text-sm">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-2 text-center text-[10px] font-semibold text-gray-600 uppercase">Qty</th>
                      <th className="px-4 py-2 text-center text-[10px] font-semibold text-gray-600 uppercase">Price</th>
                      <th className="px-4 py-2 text-right text-[10px] font-semibold text-gray-600 uppercase">Total</th>
                      ...
                      <tr key={index} className="border-t border-gray-100">
                          ...
                          <input
                            ...
                            className={`w-full bg-transparent px-0 py-1 border-0 border-b ${
                              errors[`item_${index}_description`]
                                ? "border-red-500"
                                : "border-transparent"
                            } focus:border-blue-600 focus:ring-0 outline-none text-sm placeholder-gray-400`}
                          />
                        </td>
                        <td className="px-4 py-2 text-center">
                          <input
                            ...
                            className="w-14 text-center bg-transparent px-0 py-1 border-0 border-b border-transparent focus:border-blue-600 focus:ring-0 outline-none text-sm"
                          />
                        </td>
                        <td className="px-4 py-2 text-center">
                          <input
            ...
            <div className="grid grid-cols-2 gap-6 pt-4">
              <div>
                <h3 className="text-xs font-semibold text-gray-700 uppercase mb-2 tracking-wide">
                  Notes
                </h3>
                <textarea
                  rows={4}
                  ...
                  className="w-full border border-gray-200 rounded-md p-3 text-sm focus:border-blue-600 focus:ring-1 focus:ring-blue-600 outline-none placeholder-gray-400 resize-none"
                />
              </div>
